package com.wangkm.player.video.ui.widget;
...
public class SdkDefaultFuncation extends LinearLayout implements View.OnClickListener {
    ...
    private void initViews() {
        ...
        touch_1.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        findViewById(R.id.touch_2).setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        orientation_1.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        findViewById(R.id.orientation_2).setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
