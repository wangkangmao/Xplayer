package com.wangkm.player.base.adapter.widget;

import androidx.recyclerview.widget.GridLayoutManager;
import androidx.recyclerview.widget.LinearLayoutManager;
import androidx.recyclerview.widget.RecyclerView;

import com.wangkm.player.base.adapter.interfaces.OnLoadMorePresenter;
...
public abstract class OnLoadMoreListener extends RecyclerView.OnScrollListener implements OnLoadMorePresenter {
    ...
    public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
        ...
        if(recyclerView.getLayoutManager() instanceof LinearLayoutManager){
            ...
            //暂不支持瀑布流加载更多
            Logger.INSTANCE.d(TAG,"OnLoadMoreListener-->暂不支持瀑布流加载更多");
        }
    }
