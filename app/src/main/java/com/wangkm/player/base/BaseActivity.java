package com.wangkm.player.base;
...
import com.wangkm.player.video.listener.OnMenuActionListener;
import com.wangkm.player.video.ui.widget.PlayerMenuDialog;
...
public abstract class BaseActivity <P extends BasePresenter> extends AppCompatActivity implements BaseContract.BaseView {
    ...
    /**
     * 开启全局悬浮窗播放,成功开启全局悬浮窗后当前界面将被finish界
...
//                }
//            });
            boolean globalWindow = mVideoPlayer.startGlobalWindow(ScreenUtils.INSTANCE.dpToPxInt(3), Color.parseColor("#99000000"));
            Logger.INSTANCE.d(TAG,"startGoableWindow-->globalWindow:"+globalWindow);
            if(globalWindow){
    ...
    public void onBackPressed() {
        Logger.INSTANCE.d(TAG,"onBackPressed-->"+isForbidCycle);
