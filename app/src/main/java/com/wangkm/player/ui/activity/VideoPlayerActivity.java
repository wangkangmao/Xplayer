...
import com.wangkm.exo.media.core.ExoPlayerFactory;
import com.wangkm.ijk.media.core.IjkPlayerFactory;
import com.wangkm.player.R;
import com.wangkm.player.base.BaseActivity;
import com.wangkm.player.base.BasePresenter;
import com.wangkm.player.render.CoustomSurfaceView;
import com.wangkm.player.ui.widget.TitleView;
import com.wangkm.player.video.ui.widget.SdkDefaultFuncation;
    ...
    private void initPlayer() {
        ...
        toolBarView.setOnToolBarActionListener(new ControlToolBarView.OnToolBarActionListener() {
            ...
            public void onBack() {//仅当设置showBack(true)后并且竖屏情况下才会有回调到此
                Logger.INSTANCE.d(TAG,"onBack");
                onBackPressed();
            }

            @Override
            public void onTv() {
                Logger.INSTANCE.d(TAG,"onTv");
            }

            @Override
            public void onWindow() {
                Logger.INSTANCE.d(TAG,"onWindow");
                startGlobalWindow(null);
            }

            @Override
            public void onMenu() {
                Logger.INSTANCE.d(TAG,"onMenu");
                showMenuDialog();
            }
        });
